...
<<<<<<< HEAD
                .antMatchers("/user/**").permitAll().antMatchers("/posts/**").permitAll().anyRequest().authenticated()
=======
                .antMatchers("/user/**").permitAll().antMatchers("/mails/**").permitAll().anyRequest().authenticated()
