...
const UserInfoModify = () => {
  ...
  if (file !== "") {
    ...
    preview_img = (
      <img className="userModify img" src={user.image != null ? user.image : `${userImg}`}></img>
    );
  }
      ...
      <div className="userModify-row">
        <div className="userModify-col">
          ...
          <div className="userModify main">
            ...
            <div className="userModify-title">사용자 닉네임 설정</div>
            <div className="userName">
              <input className="user-nickname-input" type="text" value={userInfo.nickname} />
            </div>
