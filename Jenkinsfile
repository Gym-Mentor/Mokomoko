    ...
    stages {   
        ...
        stage('Docker run') {
            ...
            steps {
                ...
                // docker container 실행     
                sh 'docker run -d --name frontend -v /home/ubuntu/img:/home/img -v /home/ubuntu/key:/home/key --network mokomoko -p 80:80 frontend:latest'     
                sh 'docker run -d --name backend -v /home/ubuntu/img:/home/img -v /home/ubuntu/key:/home/key --network mokomoko -p 8080:8080 backend:latest'    
            }   
        }  
    } 
}
