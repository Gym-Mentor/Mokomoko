    ...
    stages {   
        ...
        stage('Docker run') {
            ...
            steps {
                ...
                // docker container 실행     
                sh 'docker run -d --name frontend -v $HOME/img:/home/img --network mokomoko -p 80:80 frontend:latest'     
                sh 'docker run -d --name backend -v $HOME/img:/home/img --network mokomoko -p 8080:8080 backend:latest'    
            }   
        }  
    } 
}
